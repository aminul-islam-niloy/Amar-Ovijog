...
namespace AmarOvijog.Migrations
{
    ...
    [Migration("20241014065212_ComplaintwithRelation")]
    partial class ComplaintwithRelation
    {
            ...
            modelBuilder.Entity("AmarOvijog.Models.Complaint", b =>
                {
                    ...
                    b.HasOne("AmarOvijog.Models.Union", "Union")
                        .WithMany()
                        .HasForeignKey("UnionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AmarOvijog.Models.Upazila", "Upazila")
                        .WithMany()
                        .HasForeignKey("UpazilaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AmarOvijog.Models.ApplicationUser", "User")
                        .WithMany()
